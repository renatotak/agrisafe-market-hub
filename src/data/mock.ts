...
export const mockCompetitors = [
  {
    id: "comp1", name: "TerraMagna", segment: "Agrifintech / Credit", website: "terramagna.com.br",
    description_pt: "Plataforma de cr\u00e9dito rural com an\u00e1lise de risco por sat\u00e9lite. Atende mais de 2.000 distribuidores de insumos.",
    description_en: "Rural credit platform with satellite-based risk analysis. Serves over 2,000 input distributors.",
    competitor_signals: [
      { id: "s1", competitor_id: "comp1", type: "funding", title_pt: "Capta\u00e7\u00e3o Series C de US$ 45M liderada por Softbank", title_en: "US$45M Series C led by Softbank", date: "2026-02-15", source: "TechCrunch" },
      { id: "s2", competitor_id: "comp1", type: "product_launch", title_pt: "Lan\u00e7amento do m\u00f3dulo de monitoramento de CPR digital", title_en: "Digital CPR monitoring module launched", date: "2026-01-20", source: "Blog corporativo" },
      { id: "s3", competitor_id: "comp1", type: "hiring", title_pt: "Abertura de 15 vagas para time de dados", title_en: "15 data team positions opened", date: "2026-03-10", source: "LinkedIn" },
    ],
  },
  {
    id: "comp2", name: "Traive", segment: "Agrifintech / Credit", website: "traive.com",
    description_pt: "Solu\u00e7\u00f5es de cr\u00e9dito digital para agroneg\u00f3cio com foco em opera\u00e7\u00f5es de barter.",
    description_en: "Digital credit solutions for agribusiness with focus on barter operations.",
    competitor_signals: [
      { id: "s4", competitor_id: "comp2", type: "partnership", title_pt: "Parceria com Banco ABC Brasil para financiamento de CPRs", title_en: "Partnership with ABC Brasil Bank for CPR financing", date: "2026-01-10", source: "Valor Econ\u00f4mico" },
      { id: "s5", competitor_id: "comp2", type: "news", title_pt: "Crescimento de 200% no volume de opera\u00e7\u00f5es em 2025", title_en: "200% growth in operations volume in 2025", date: "2026-02-28", source: "Bloomberg Linha" },
    ],
  },
  {
    id: "comp3", name: "Agrotools", segment: "Agtech / Data", website: "agrotools.com.br",
    description_pt: "Intelig\u00eancia territorial e compliance ambiental com base geoespacial.",
    description_en: "Territorial intelligence and environmental compliance with geospatial data.",
    competitor_signals: [
      { id: "s6", competitor_id: "comp3", type: "product_launch", title_pt: "Nova API de due diligence ESG para bancos", title_en: "New ESG due diligence API for banks", date: "2026-02-05", source: "Fintech News" },
    ],
  },
  {
    id: "comp4", name: "Bart Digital", segment: "Agrifintech / Sales", website: "bartdigital.com",
    description_pt: "CRM e gest\u00e3o de vendas para distribuidores de insumos agr\u00edcolas.",
    description_en: "CRM and sales management for agricultural input distributors.",
    competitor_signals: [
      { id: "s7", competitor_id: "comp4", type: "hiring", title_pt: "Expandindo time comercial (10+ vagas em GO e MT)", title_en: "Expanding sales team (10+ positions in GO and MT)", date: "2026-01-30", source: "LinkedIn" },
      { id: "s8", competitor_id: "comp4", type: "partnership", title_pt: "Integra\u00e7\u00e3o com Siagri para ERP de revendas", title_en: "Integration with Siagri for reseller ERP", date: "2026-03-15", source: "Press release" },
    ],
  },
  {
    id: "comp5", name: "Agrosafety", segment: "Agtech / Insurance", website: "agrosafety.com.br",
    description_pt: "Monitoramento agr\u00edcola por sat\u00e9lite e an\u00e1lise de risco para seguradoras.",
    description_en: "Satellite agricultural monitoring and risk analysis for insurance companies.",
    competitor_signals: [
      { id: "s9", competitor_id: "comp5", type: "news", title_pt: "Cobertura expandida para culturas de arroz e feij\u00e3o", title_en: "Coverage expanded to rice and beans crops", date: "2026-02-15", source: "AgriNews" },
    ],
  },
];
